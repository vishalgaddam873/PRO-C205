...
def gameWindow():
    ...
    # Creating name board
    player1Lable = canvas2.create_text(400,  screen_height/2 + 100, text = player1Name, font=("Chalkboard SE",80), fill='#fff176' )
    player2Lable = canvas2.create_text(screen_width - 300, screen_height/2 + 100, text = player2Name, font=("Chalkboard SE",80), fill='#fff176' )
...
def recivedMsg():
    ...
    while True:
        ...
        if(player1Name != 'joining' and canvas2):
            canvas2.itemconfigure(player1Lable, text=player1Name)

        if(player2Name != 'joining' and canvas2):
            canvas2.itemconfigure(player2Lable, text=player2Name)
